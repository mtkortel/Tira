...
public class DistanceMatrix {
    ...
    private InputSource getXML(String url) throws MalformedURLException, IOException {
        ...
        if (!"".equals(Launcher.proxy_host)){
            ...
            //System.setProperty("http.proxyHost", "172.17.35.2");
            //System.setProperty("http.proxyPort", "8080");
            Proxy proxy = new Proxy(Proxy.Type.HTTP, new InetSocketAddress(Launcher.proxy_host, Launcher.proxy_port));
        ...
        //Proxy proxy = new Proxy(Proxy.Type.HTTP, new InetSocketAddress("172.17.35.2", 8080));
